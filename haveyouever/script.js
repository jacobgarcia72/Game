...
var questionController = (function() {
  ...
  var questionBank = [
    'gone sky diving','gone bungee jumping','gone zip-lining','gotten fired','been in handcuffs','smoked weed','seen the Grand Canyon','been inside a limo','ridden in an ambulence','been on TV','kissed a stranger','been skinny dipping','cheated on a test','shoplifted','made a prank phone call','been the cause of a collision with another vehicle','broken a bone','had a major surgery','ridden a horse','been to a nude beach','flipped off a cop','used a fake ID','toilet papered somebody\'s house or car','egged somebody\'s house','been arrested','had to get stiches','lied in an interview to get a job','owned a hamster','gone skiing','gone water skiing','gone snowboarding','gotten a tattoo','lived in another country','traveled abroad','seen the Golden Gate Bridge','killed and eaten an animal','shot a bow and arrow','given someone a fake number','had a surprise birthday party','dined and dashed','totaled a car in an accident','been kicked out of a bar','had acupuncture','played poker','slept on the job','hitchhiked','sung karaoke in a public venue','done stand-up comedy','done improv comedy','called a radio station','been on a motorcycle','been in a YouTube video','donated blood','peed in a pool','been on a train','voted third party','been or tried to be a vegan or vegetarian','won money off of scratch off tickets','had a pet bird','walked around barefoot in public','gone fishing','picked up a hitchhiker','eaten an insect','been in a helicopter','met a celebrity','snuck into a movie','ridden a mechanical bull','gone cliff jumping','crashed a wedding','played Dungeons and Dragons','sung on stage','been canoeing or kayaking','been on a photo scavenger hunt','gone caving','caught fireflies','been speed dating','called the cops on someone','been to New York City','been to China','had a pet reptile','been to Mexico','driven more than 100 MPH (160 km/h)','been in a band','had a tattoo removed','played Truth or Dare','built a sandcastle','slept under a bridge','been on a cruise','gotten evicted','run from a cop or security gaurd','walked out of a movie','fallen asleep at the wheel','gotten someone else fired','had a crush on a friend\'s parent','thrown up at an amusement park','sent someone to the hospital','lied about a family member dying to get out of something','broken a window','had a near-death experience','seen a tornado','fallen down the stairs','gone on a blind date','lied to get out of a traffic ticket','entered a house through the window','ridden an animal other than a horse','had an article published in a newspaper or magazine','forged someone else\'s signature','failed a course in college','slept in a tent','pulled the fire alarm','kept a consistent blog','kept a consistent journal/diary','worked in fast food','worked in retail','pretended to be sick to get out of work','driven for Uber or Lyft','Seen Niagra Falls','gotten a traffic ticket','played the lottery','been to Las Vegas','gotten a parking ticket','been in a parade','uploaded a video to YouTube','had a MySpace','been suba diving','seen the Pacific Ocean','learned the alphabet in sign language','changed a tire','written a letter to be read in the future','taken pictures in a photo booth','played pinball','won a carnival game','gotten ice cream from an ice cream truck','made a tie dye shirt','played Monopoly','written a fan letter','sold something on eBay','been on a jury','attended a Murder Mystery dinner','drawn on someone\'s face while they were asleep','played paintball','seen Mt. Rushmore','made a cake for someone\'s birthday','planted a tree','grown tomatoes','had a garden','eaten fruit right off the tree','had a tree house','been in Boy Scouts or Girl Scouts','bought lemonade from a lemonade stand','seen the Wizard of Oz','gotten a professional massage','gone Christmas caroling','adopted a shelter animal','gone ice skating','been on a segway','gone on a hayride','been to a rock concert','climbed a rock wall','played golf','played miniature golf','gone bowling','played lazer tag','carved a pumpkin','participated in a charity walk/run','tried out for a game show or reality show','made ice cream','been to a musical','been in a musical','been in a professional stage production','played tennis','played hockey','played baseball','played a harmonica','written a letter to someone in congress','written a letter to the editor','used a metal detector','built a campfire','been able to juggle','bought art from a local artist','decorated gingerbread people','made homemade bread','learned a song on the piano','fed the ducks at a park','drawn plans for a dream house','gone garage saling','contributed to someone\'s kickstarter/crowdfunder','done yoga','had a scrapbook','gotten a book signed by the author','been part of a book blub','ridden in a horse-drawn carriage','done open mic','played soccer','been tied to a chair','known a programming language','known how to knit or crochet','shopped at a thrift store','learned to swing dance','been to a hockey game','gotten a DUI','had feelings for a best friend\'s significant other','been in an earthquake','come close to drowning','failed a driving test','plagiarized an essay','broken up with someone over text','filmed a police encounter','been searched by the police','been to a funeral','been denied entry to a club','been banned from somewhere','run a red light','watched Titanic','boycotted something','launched fireworks','sprayed graffiti','gone a week without showering','swam in the ocean','eaten out the dumpster','picked up furniture from the side of the road','used Craigslist','voted in an election','pooped outdoors','bought a drink for someone underage','sat on a rooftop','written something in a bathroom stall','held a snake','driven a stick','participated in a protest or political rally','been in the back of a police car','hula hooped','played Minecraft','seen the Lion King','seen Toy Story','been in a long-distance relationship','tried to guess someone ele\'s personal password','slept overnight in a car','collected Pokemon cards','played Pokemon Go','had a LEGO collection','killed an animal other than a bug','been asked to leave a store','read someone else\'s text messages without them knowing','read from someone else\'s diary/journal without them knowing','milked an animal','gotten a lease violation','given money to a homeless person','walked on a beach at night','been inside a fire truck','pointed a gun at someone','investigated a noise with gun in hand','dropped a phone or wallet in the toilet','been in a relationship for more than a year','visualized killing someone','trolled a telemarketer','changed clothes in a vehicle','gotten locked out and had to call a locksmith'
  ];
